        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AboutTheDoctor = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ProfilePicture = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Speciality = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Degree = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    TotalRatings = table.Column<int>(type: "int", nullable: true),
                    ActualRting = table.Column<decimal>(type: "money", nullable: true),
                    YearsOfExperience = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    HomeVisitFees = table.Column<decimal>(type: "money", nullable: true),
                    IsVisitHome = table.Column<bool>(type: "bit", nullable: false),
                    LastUpdate = table.Column<DateOnly>(type: "date", nullable: false),
                    CreationDate = table.Column<DateOnly>(type: "date", nullable: false),
                    DeletionDate = table.Column<DateOnly>(type: "date", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Address_StreetAddress = table.Column<string>(type: "nvarchar(80)", maxLength: 80, nullable: false),
                    Address_governorate = table.Column<string>(type: "nvarchar(80)", maxLength: 80, nullable: false),
                    LastUpdate = table.Column<DateOnly>(type: "date", nullable: false),
                    CreationDate = table.Column<DateOnly>(type: "date", nullable: false),
                    DeletionDate = table.Column<DateOnly>(type: "date", nullable: false),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DoctorApplicationUserId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    Fees = table.Column<decimal>(type: "money", nullable: false),
                    ExmainationDuration = table.Column<TimeOnly>(type: "time", nullable: false),
                    OpeningHour = table.Column<TimeOnly>(type: "time", nullable: false),
                    ClosingHour = table.Column<TimeOnly>(type: "time", nullable: false),
                    OpeningDays = table.Column<int>(type: "int", nullable: false),
                    Address_City = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    Address_StreetAddress = table.Column<string>(type: "nvarchar(80)", maxLength: 80, nullable: false),
                    Address_governorate = table.Column<string>(type: "nvarchar(80)", maxLength: 80, nullable: false),
                    LastUpdate = table.Column<DateOnly>(type: "date", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DoctorApplicationUserId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    PatientApplicationUserId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    Rate = table.Column<int>(type: "int", nullable: true),
                    Comment = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_DoctorReviews", x => new { x.PatientId, x.DoctorId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReservtionPeriodNumber = table.Column<int>(type: "int", nullable: false),
